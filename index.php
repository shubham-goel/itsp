<?php include "header.php"; ?>
	...
	<div class="container text-center">
		<br> <br>
		<h2 class="thin">How ITSP 2014 works</h2>
		<p class="text-muted">
			1. Propose a Project,submit an abstract .<br>
			2. Design,Build,Develop and Code amazing things in Summer.<br>
			3. Achieve Ultimate Glory .
		</p>
	</div>
	<!-- /Intro-->
